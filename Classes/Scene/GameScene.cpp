...
//------------------------------------------------------------------------//
    ...
    // Show the Score
    CCLabelTTF* lbl_score = CCLabelTTF::create("SCORE:", STANDARD_FONT, GAME_INFO_FONT_SIZE * SCALE);
    ...
    CCLabelTTF* lbl_scoreValue = CCLabelTTF::create("", STANDARD_FONT, GAME_INFO_FONT_SIZE * SCALE);
    ...
    CCLabelTTF* lbl_level = CCLabelTTF::create(lbl_levelString, STANDARD_FONT, 45 * SCALE);
