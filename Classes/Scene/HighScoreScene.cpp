...
void HighScoreScene::createUI()
{
    ...
    // Add HighScore Label
    CCLabelTTF* lbl_totalScore = CCLabelTTF::create("Total Score : ", STANDARD_FONT, 40 * SCALE);
    ...
    CCLabelTTF* lbl_totalscore_value = CCLabelTTF::create(score, STANDARD_FONT, 40 * SCALE);
    ...
    CCLabelTTF* lbl_letterscount_value = CCLabelTTF::create(score, STANDARD_FONT, 40 * SCALE);
    ...
    CCLabelTTF* lbl_difficulty_value = CCLabelTTF::create(score, STANDARD_FONT, 40 * SCALE);
