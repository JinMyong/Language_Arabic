...
void GameOptionsScene::createUI()
{
    ...
    // Add tittle font style  // Removed by kerberos
...
void GameOptionsScene::createMenu()
{
    ...
    // Add Normal Button  // change by kerberos Ypositions -old = 222
    ...
    btn_diff_normal->setPosition(ccp(winSize.width * 0.5 - PADDING_X * SCALEX, winSize.height - 290 * SCALEY));
    ...
    // Add Font Print  // Removed by kerberos
...
//    
    // Add Font Script  // Removed by kerberos
...
// Removed by kerberos                                 btn_font_print,    btn_font_script,
                                     NULL);
...
void GameOptionsScene::initMenuVariables()
{
    ...
    // Init Font Style  // Removed by kerberos
