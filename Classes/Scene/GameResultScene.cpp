...
// Add coin count label
    ...
    CCLabelTTF* lbl_coin = CCLabelTTF::create(coin_str, STANDARD_FONT, 40 * SCALE);
...
// Add Game Result Title
    ...
    CCLabelTTF* lbl_title = CCLabelTTF::create(title->getCString(), STANDARD_FONT, 60 * SCALEX);
...
// Show Target Score Level
    ...
    CCLabelTTF* lbl_target_text = CCLabelTTF::create("Target Score : ", STANDARD_FONT, GAME_RESULT_FNTSIZE * SCALE);
    ...
    CCLabelTTF* lbl_target_score = CCLabelTTF::create(target_value_str, STANDARD_FONT, GAME_RESULT_FNTSIZE * SCALE);
...
// Show Current Score
    ...
    CCLabelTTF* lbl_Current = CCLabelTTF::create("Your Score : ", STANDARD_FONT, GAME_RESULT_FNTSIZE * SCALE);
    lbl_Current->setAnchorPoint(ccp(1, 0.5));
    lbl_Current->setPosition(ccp(420 * SCALEX, 850 * SCALEY));
    this->addChild(lbl_Current);
    
    CCLabelTTF* lbl_current_score = CCLabelTTF::create(current_value_str, STANDARD_FONT, GAME_RESULT_FNTSIZE * SCALE);
...
// Show Studied Letters Counts
    ...
    CCLabelTTF* lbl_lettercount = CCLabelTTF::create("Studied Letters : ", STANDARD_FONT, 40 * SCALE);
    ...
    CCLabelTTF* lbl_letterscount_value = CCLabelTTF::create(temp_value, STANDARD_FONT, 40 * SCALE);
...
// Show Game difficulty
    ...
    CCLabelTTF* lbl_difficualty = CCLabelTTF::create("Game Difficulty : ", STANDARD_FONT, 40 * SCALE);
    ...
    CCLabelTTF* lbl_difficulty_value = CCLabelTTF::create(temp_value, STANDARD_FONT, 40 * SCALE);
...
// Show Earned Coins
    CCLabelTTF* lbl_earnedCoins = CCLabelTTF::create("Coins Earned : ", STANDARD_FONT, 40 * SCALE);
    ...
    CCLabelTTF* lbl_coins_count = CCLabelTTF::create("0", STANDARD_FONT, 40 * SCALE);
...
// Show Shoot Item
    CCLabelTTF* lbl_shootitem = CCLabelTTF::create("Throwing Item", STANDARD_FONT, 40 * SCALE);
