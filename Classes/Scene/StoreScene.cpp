...
// Add Star
    ...
    CCLabelTTF* balloon_price = CCLabelTTF::create(price, STANDARD_FONT, COIN_FONTS_SIZE * SCALE);
...
// Add Matzah Ball
    ...
    CCLabelTTF* egg_price = CCLabelTTF::create(price, STANDARD_FONT, COIN_FONTS_SIZE * SCALE);
...
// Add Matzah
    ...
    CCLabelTTF* airplane_price = CCLabelTTF::create(price, STANDARD_FONT, COIN_FONTS_SIZE * SCALE);
